...
The numerical results compound on what the grpahical results were telling us, the placebo group contracted Covid approximatly 70% of the time where the vaccinated group contracted Covid 30% of the time. We can see that the vaccine is generally effective in this testing scenario.
